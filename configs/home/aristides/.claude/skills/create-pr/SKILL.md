...
This guide explains how to create pull requests using the GitHub CLI (gh binary) in our project.

## When to Use

- When the user asks to create a PR
- When the user says "open a pull request" or "submit PR"
...
1. First, prepare your PR description with a concise summary that clearly explains the changes made across all the threads/sessions where work was done in the current branch.
...
4. Forget to create the PR in DRAFT mode.
